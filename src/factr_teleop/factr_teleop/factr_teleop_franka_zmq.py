...
class FACTRTeleopFrankaZMQ(FACTRTeleop):
    ...
    def __init__(self):
        super().__init__()
        self.gripper_feedback_gain = self.config["controller"]["gripper_feedback"][
            "gain"
        ]
        self.gripper_torque_ema_beta = self.config["controller"]["gripper_feedback"][
            "ema_beta"
        ]
    ...
    def set_up_communication(self):
        ...
        if self.enable_gripper_feedback:
            ...
            self.obs_gripper_torque_pub = self.create_subscription(
                JointState,
                f"/gripper/{self.name}/obs_gripper_torque",
    ...
    def _gripper_external_torque_callback(self, data):
        ...
        self.gripper_external_torque = (
            self.gripper_torque_ema_beta * self.gripper_external_torque
...
def main(args=None):
    ...
    try:
        ...
        factr_teleop_franka_zmq.get_logger().info(
