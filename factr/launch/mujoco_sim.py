...
from src.robots.robot import BimanualRobot, PrintRobot
from src.robots.robot_node import ZMQServerRobot
...
def launch_robot_server(args: Args):
    ...
    if args.robot == "sim_ur":
        ...
        from src.robots.sim_robot import MujocoRobotServer
